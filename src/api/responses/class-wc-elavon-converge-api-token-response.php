 ...
 * @since 2.0.0
 */
class WC_Elavon_Converge_API_Token_Response extends WC_Elavon_Converge_API_Credit_Card_Transaction_Response implements Framework\SV_WC_Payment_Gateway_API_Create_Payment_Token_Response {
