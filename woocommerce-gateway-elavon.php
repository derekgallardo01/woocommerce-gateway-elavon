 ...
 * Documentation URI: https://docs.woocommerce.com/document/elavon-vm-payment-gateway/
 ...
 *
 * Woo: 18722:2732aedb77a13149b4db82d484d3bb22
 ...
 * @since 2.4.0
 */
class WC_Elavon_Converge_Loader {
	...
	const PLUGIN_NAME = 'WooCommerce Elavon Converge';


	/** @var WC_Elavon_Converge_Loader single instance of this class */
	...
	public function init_plugin() {
		...
		require_once( plugin_dir_path( __FILE__ ) . 'class-wc-elavon-converge.php' );
	...
	/**
	 * Displays any admin notices added with WC_Elavon_Converge_Loader::add_admin_notice()
	 *
	 * @since 2.4.0
	 */
	...
	/**
	 * Gets the main WC_Elavon_Converge_Loader instance.
	 *
	 * Ensures only one instance can be loaded.
	 *
	 * @since 2.4.0
	 *
	 * @return WC_Elavon_Converge_Loader
	 */
...
// fire it up!
WC_Elavon_Converge_Loader::instance();
